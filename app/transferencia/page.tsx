      ...
      <main className="min-h-screen bg-white text-black font-sans">
        ...
        <div className="max-w-xl mx-auto px-4 py-12 pb-24">
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-between items-center py-4 border-b border-gray-100">
                ...
                <button onClick={() => copyToClipboard("BBVA", "banco")} className="text-[10px] uppercase tracking-widest font-medium text-black hover:text-gray-500">
              ...
              <div className="flex justify-between items-center py-4 border-b border-gray-100">
                ...
                <button onClick={() => copyToClipboard("01218000123456789", "clabe")} className="text-[10px] uppercase tracking-widest font-medium text-black hover:text-gray-500">
              ...
              <div className="flex justify-between items-center py-4 border-b border-gray-100">
                ...
                <button onClick={() => copyToClipboard("BLACKS", "beneficiario")} className="text-[10px] uppercase tracking-widest font-medium text-black hover:text-gray-500">
              ...
              <div className="flex justify-between items-center py-4 border-b border-gray-100">
                ...
                <button onClick={() => copyToClipboard(`ORDER-${orderId}`, "referencia")} className="text-[10px] uppercase tracking-widest font-medium text-black hover:text-gray-500">
          ...
          <div className="flex flex-col gap-3 mt-8">
            {orderId ? (
              <Link href="/orders" className="w-full py-4 bg-black text-white text-[11px] uppercase text-center">
                Ver Estado del Pedido
              </Link>
            ) : (
              <button disabled className="w-full py-4 bg-gray-100 text-gray-400 text-[11px] uppercase">
                ID no disponible
              </button>
            )}
            <Link href="/" className="w-full py-4 border border-black text-black text-[11px] uppercase text-center">
              Volver a la Tienda
            </Link>
          </div>
